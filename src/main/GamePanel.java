...
public class GamePanel extends JPanel implements Runnable {
    ...
    // --- 5. MENU ASSETS & LOGIC ---
    public BufferedImage menuBg, btnNewGame, btnNewGame2, btnExit2 , btnExit, btnGO, btnGO2,
                         playerIcon, npc1, npc2, npc3, hudBackground, backgroundBoss,
                         btnMusicOn, btnMusicOff, btnSoundOn, btnSoundOff;

    public int menuX, menuY;
    
    // Public để MouseHandler truy cập check click
    public Rectangle newGameRect, exitRect, gameOptionRect, musicRect, soundRect, menuArea;
    
    // Biến điều khiển Animation Menu
    public int commandNum = -1; // -1: None, 0:NewGame, 1:Options, 2:Exit, 3:Music, 4:Sound
    ...
    public void setupMenuPositions() {
        ...
        int newMenuWidth = bgW + 200; 
        int newMenuHeight = bgH + 50;  
        int bgDrawX = menuX - 50;    
        menuArea = new Rectangle(bgDrawX, menuY, newMenuWidth, newMenuHeight);
